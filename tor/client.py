...
from .tor_route import *
from .tor_route import START_SERVER
...
class AnonymousClient:
    ...
    def start_listener(self) -> int:
        try:
            ...
            self.tor_route.start_tor()

            for port in preferred_ports:
                try:
                    self.ephimeral_service = self.tor_route.create_hidden_service(port)
                    self.listening_socket = START_SERVER(port)
